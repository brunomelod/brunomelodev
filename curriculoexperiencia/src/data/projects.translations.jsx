  ...
  const projects = {
    'Projeto Científico': {
      ...
      description: [
        ...
        isPT
          ? 'O CalculAgro é um projeto de estudo científico privado em desenvolvimento: sistema web automatizado para estimativa do balanço anual de carbono no solo (ΔSOC) em agricultura, com sensoriamento remoto, modelos RothC/IPCC e simulação de Monte Carlo para quantificação de incertezas. O trabalho está sendo desenvolvido em parceria com a consultoria com a Doutorada em Agronomia dos Estados Unidos, com foco na validação científica dos modelos, refinamento metodológico e preparação de material para publicação acadêmica.'
          : 'CalculAgro is a private scientific study project in development: an automated web system for annual soil carbon balance (ΔSOC) estimation in agriculture, with remote sensing, RothC/IPCC models, and Monte Carlo simulation for uncertainty quantification. The work is being developed in partnership with a consulting company with a PhD in Agronomy from the United States, with a focus on scientific validation of the models, methodological refinement, and preparation of material for academic publication.',
        isPT
    ...
    'React & Tailwind CSS': {
      description: [
        ...
        isPT
          ...
          : 'I developed a gym management system with a frontend in React, TypeScript and Tailwind CSS, and a backend in Node.js, JavaScript and Express. The Fitmark Club corporate portal centralizes marketing materials, headquarters announcements and unit resources in a modern and responsive interface.',
        ...
        isPT
          ...
          : 'I developed an AI system for digital marketing with a frontend in React, TypeScript and Tailwind CSS, and a backend in Node.js, JavaScript and Express, with an admin panel for campaign management and content automation.',
      ],
    },
    ...
    'NodeJS & Express & MongoDB': {
      description: [
        ...
        isPT
          ...
          : 'I created a complete course playlist from scratch on CRUD development with Node.js, Express and MongoDB. The course covers from fundamental Node.js concepts, development environment configuration, MongoDB database configuration, all necessary configuration, to complete implementation of CRUD operations (Create, Read, Update, Delete) for users.',
        isPT
        ...
        isPT
          ...
          : 'I developed the entire backend of the Fitmark Club gym management system using Node.js, JavaScript, Express and PostgreSQL. The full server-side architecture — REST APIs, authentication, unit management, materials and corporate announcements — was built with this stack, with data persistence in PostgreSQL.',
        ...
        isPT
          ...
          : 'I developed the entire backend of the Sheepz AI digital marketing system using Node.js, JavaScript, Express and PostgreSQL. The full server-side architecture — REST APIs, admin panel, campaign management and content automation — was built with this stack, with data persistence in PostgreSQL.',
      ],
    },
  }
